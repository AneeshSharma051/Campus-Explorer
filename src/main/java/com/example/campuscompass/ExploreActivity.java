...
public class ExploreActivity extends AppCompatActivity {
    ...
    String []places = {"AA-11", "AA-12", "AA-13", "C-11", "C-12", "SH1", "C13", "D-14", "E-14", "Department of Pharmacy", "Computer Centre", "A-21", "A-22", "C-21", "C-22", "C-23", "D-23", "D-24", "E-24", "Computer Centre-2", "A-31", "A-32", "A-33", "C-31", "C-32", "C-33", "D-33", "D-34", "E-34", "F-31", "F-32", "F-33", "Department Library of Pharmacy", "", "", "", "", "", "", "", "", "", "", ""};
    ...
    List<String> wifi2 = new ArrayList<>(Arrays.asList("Shiv-Shakti_5","Assist@#9009"));
    List<String> wifi3 = new ArrayList<>(Arrays.asList("Shiv-Shakti","" +"Assist@#9009"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        explore2=findViewById(R.id.ShowonMap);
        ...
        explore2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                dialog.setContentView(R.layout.dialog_image); // Replace "dialog_image" with the layout file name

                // Find the ImageView in the dialog layout
                ImageView imageView = dialog.findViewById(R.id.dialogImageView);

                // Set the desired image resource
                imageView.setImageResource(R.drawable.mappu); // Replace "your_image" with the actual image resource name
        ...
        /*explore2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Load image
                Toast toast = Toast.makeText(ExploreActivity.this, "", Toast.LENGTH_LONG);
                ImageView imageView = new ImageView(ExploreActivity.this);
                imageView.setImageResource(R.drawable.mappu); // Replace "your_image" with the actual image resource name
...
//        }
    ...
    private void makeLocations() {
        ...
        {
            String []places = {"LH301", "LH302", "", "D-14", "", "C-11", "AA-11", "SH1", "C-12", "BT Staffroom", "AA-12", "I&P Lab"};
            ...
            Location node1 = new Location("SH1", new ArrayList<String>(Arrays.asList(places[7], " ", " ")), new ArrayList<Integer>(Arrays.asList(PlacePosition.bottomLeft, PlacePosition.right, PlacePosition.bottomRight)),R.drawable.second1 , 2, false, 0f, null, null, null, null, null);
            Location node2 = new Location("AA-11", new ArrayList<String>(Arrays.asList(places[6], " ")), new ArrayList<Integer>(Arrays.asList(PlacePosition.bottomRight, PlacePosition.left)),R.drawable.second2, 2, false, 0f, null, null, null, null, null);
            Location node3 = new Location("Washroom", new ArrayList<String>(Arrays.asList(places[4], places[10], "B-Block")), new ArrayList<Integer>(Arrays.asList(PlacePosition.topRight, PlacePosition.bottomRight, PlacePosition.right)), R.drawable.second3, 2, false, 45f, null, null, null, null, null);
            Location node4 = new Location("D-14", new ArrayList<String>(Arrays.asList(places[11], places[2], places[3])), new ArrayList<Integer>(Arrays.asList(PlacePosition.right, PlacePosition.topLeft, PlacePosition.right)), R.drawable.second4, 2, false, 135f, null, null, null, null, null);
